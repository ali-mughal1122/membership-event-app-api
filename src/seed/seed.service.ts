...
export class SeedService implements OnModuleInit {
  ...
  private async seedPlans() {
    const definitions: Array<Partial<Plan>> = [
      ...
      {
        name: 'Vognmand Plus',
        description: 'For large fleets and enterprise operators. Includes dedicated account manager.',
        price: 9990,
        durationMonths: 12,
        features: [
          'All Vognmand benefits',
      ...
      {
        name: 'Student Chauffør',
        description: 'Discounted membership for taxi drivers in training or part-time students.',
        price: 99,
        durationMonths: 1,
        features: [
      ...
      },
      {
        ...
        description: 'For vendors and companies wanting to support the association.',
        price: 15000,
        durationMonths: 12,
        features: [
          'Logo on association website',
    ...
    const people: Array<{
      ...
      durationMonths: number;
        ...
        },
        {
          ...
          name: 'Maria Jensen',
          phone: '+45 25 11 22 33',
          address: 'Frederiksborgvej 45, 2400 København NV',
          planName: 'Chauffør',
          status: 'ACTIVE',
          startMonthsAgo: 1,
          durationMonths: 1,
        ...
        {
          email: 'peter.kristensen@example.com',
          name: 'Peter Kristensen',
          phone: '+45 27 88 99 00',
          address: 'Søndergade 12, 5000 Odense C',
          planName: 'Vognmand Plus',
          status: 'ACTIVE',
          startMonthsAgo: 5,
          durationMonths: 12,
        },
        {
          email: 'kamilla.poulsen@example.com',
          name: 'Kamilla Poulsen',
          phone: '+45 29 33 44 11',
  ...
  private async seedEvents() {
    const definitions = [
      ...
      {
        title: 'Tech Talk: Future of Taxis',
        slug: '/events/tech-talk-future-of-taxis',
        description: 'A deep dive into self-driving cars, ride-sharing algorithms, and the future of the taxi industry.',
        date: new Date('2027-02-20T16:00:00'),
        time: '16:00',
        location: 'Bella Center, København',
        status: 'Published',
        membershipRequired: false,
        registrationDeadline: new Date('2027-02-18T23:59:59'),
        banner: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&w=1600&q=80',
        agenda: [
          { time: '16:00', title: 'Keynote', description: 'The Future of Mobility.' },
          { time: '17:30', title: 'Panel Discussion', description: 'How traditional fleets adapt.' },
        ],
      },
      {
        title: 'First Aid Course',
        slug: '/events/first-aid-course',
        description: 'Mandatory first aid refresher for all active drivers.',
        date: new Date('2026-11-15T09:00:00'),
        time: '09:00',
        location: 'Røde Kors Center, København',
        status: 'Published',
        membershipRequired: true,
        ...
        agenda: [
          { time: '09:00', title: 'Basic Life Support', description: 'CPR and AED training.' },
          { time: '12:00', title: 'Emergency Scenarios', description: 'Handling passenger emergencies.' },
        ],
      }
    ];
    ...
    const threads: Array<{
      ...
      unreadForMember: boolean;
        ...
        },
        {
          email: 'maria.jensen@example.com',
          category: 'General Question',
          subject: 'Discount on car wash?',
          memberMessage: 'Are there any new discount agreements for car washes in the Copenhagen area?',
          adminReply: 'Yes! Check out our new partner page for a 15% discount at WashWorld.',
          status: SupportStatus.RESOLVED,
          unreadForAdmin: false,
          unreadForMember: true,
        },
        {
          email: 'peter.kristensen@example.com',
          category: 'Payment Problem',
          subject: 'Upgraded to Vognmand Plus',
          memberMessage: 'I just upgraded my plan, but I am still seeing the old limits on my fleet management tools.',
          status: SupportStatus.OPEN,
          unreadForAdmin: true,
          unreadForMember: false,
        },
